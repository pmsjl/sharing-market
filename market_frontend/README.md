...
[![star](https://gitee.com/xiaobaitiao_z/vue3_trade_backend/badge/star.svg?theme=dark)](https://gitee.com/xiaobaitiao_z/vue3_trade_frontend)  [![gitee](https://badgen.net/badge/gitee/xiaobaitiao_z/red)](https://gitee.com/xiaobaitiao_z)  [![github](https://badgen.net/badge/github/github?icon)](https://github.com/)
...
+ 仓库不提供可直接登录的用户或管理员凭据。请在本地环境自行创建账号，并在部署前更换所有演示数据和密钥。
