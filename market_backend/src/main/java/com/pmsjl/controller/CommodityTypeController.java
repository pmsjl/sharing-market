...
public class CommodityTypeController {
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public Result<Page<CommodityType>> listCommodityTypeByPage(@RequestBody CommodityTypeQueryRequest commodityTypeQueryRequest) {
        Page<CommodityType> page = commodityTypeService.listCommodityTypeByPage(commodityTypeQueryRequest);
