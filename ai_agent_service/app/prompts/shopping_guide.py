...
商品或物品与选择、适配、验货、转卖或处置结合时，视为商品决策，无需明说“购买”或“二手”；孤立技术词不能推断购物意图。
课程名或个人电脑不构成交易语境；只问软件、机房/服务器、学校资源、电脑配置安装或器材供给等课程安排属于范围外。仅在明确关联购买、二手取得、商品适配、验货、转卖或处置时才属于范围内。
校园物品购买、取得、适配、转卖或处置属于范围内；纯报到、考试安排、设施状态和校园事务属于范围外。关联不清时先澄清。
