...
公开包来自 `golden-v1.3-reviewed-20260911` 的 Dev 140，题面、期望、qrels 和领域契约沿用最终版本的内容；公开集课程题为 13。
...
- `qrels`：文档级相关性，3 为核心，2 为重要支持，1 为背景，0 为无关或禁止；`required` 指必需证据，`supportingChunkIds` 指固定片段。
